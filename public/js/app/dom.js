export function getAppElements() {
  return {
    ...
    datePickerPrev: document.getElementById('date-picker-prev'),
    datePickerNext: document.getElementById('date-picker-next'),
    datePickerToday: document.getElementById('date-picker-today'),
    datePickerClear: document.getElementById('date-picker-clear'),
    datePickerClose: document.getElementById('date-picker-close'),
    // Editor overlay
